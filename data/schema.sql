...
VALUES ('DiegoBP12',MD5(concat('admin', 'kuorra_key')), 0, 1, 'Asesor', 'asesor@gmail.com','TIC:SI', MD5(concat('asesor', 'kuorra_key', '2016/06/04')), 0),
('DiegoBP11',MD5(concat('guess', 'kuorra_key')), 1, 1, 'estandar', 'estandar@gmail.com','TIC:SI', MD5(concat('estandar', 'kuorra_key','2016/06/04')), 0);


SELECT * FROM users;
SELECT * FROM sessions;

CREATE USER 'hawk'@'localhost' IDENTIFIED BY 'hawk.2018';
